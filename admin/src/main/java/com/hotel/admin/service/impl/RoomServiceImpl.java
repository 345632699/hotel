...
//        roomDto.setTitle(item.getTitle());
//        roomDto.setSketch(item.getSketch());
//        roomDto.setRentPrice(item.getRentPrice());
//        roomDto.setDepositPrice(item.getDepositPrice());
//        roomDto.setCheckInTime(item.getCheckInTime());
//        roomDto.setCheckOutTime(item.getCheckOutTime());
//        roomDto.setAddress(item.getAddress());
//        roomDto.setRoomPassword(item.getRoomPassword());
//        roomDto.setDescription(item.getDescription());
//        roomDto.setCreatedAt(item.getCreatedAt());
//        roomDto.setUpdatedAt(item.getUpdatedAt());
